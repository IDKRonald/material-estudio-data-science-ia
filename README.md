...
- [An Introduction to Statistical Learning](https://www.statlearning.com) `Libro`  
...
- [Neural Networks from Scratch](https://nnfs.io) `Libro`  
...
- [karpathy/nanoGPT](https://github.com/karpathy/nanoGPT) `Repo`  
...
- [Datos Abiertos Colombia](https://www.datos.gov.co/browse?sortBy=newest&page=1&pageSize=20) `Sitio`  
  Portal oficial del Estado colombiano con miles de conjuntos de datos publicados por entidades públicas.

- [Kaggle Datasets](https://www.kaggle.com/datasets) `Sitio`  
...
```markdown
- [Nombre del recurso](https://enlace) `Etiqueta`  
